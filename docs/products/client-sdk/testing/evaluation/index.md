...
This section provides comprehensive documentation for evaluation in the Client Sdk.
...
Step-by-step instructions for implementing evaluation in your applications.
...
=== "TypeScript"
    ...
    ```typescript
    // TypeScript example for evaluation
