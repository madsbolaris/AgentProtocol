...
///
/// Verifies Run model per Agent Protocol Protocol specification.
///
/// DO NOT EDIT THIS FILE MANUALLY.
/// Regenerate with: python scripts/generation/generate-tests.py --compliance
/// </summary>
public class RunExecutionComplianceTests : IClassFixture<WebApplicationFactory<EchoM365::Program>>
{
    private readonly HttpClient _client;
    private readonly MessageSerializer _serializer;

    public RunExecutionComplianceTests(WebApplicationFactory<EchoM365::Program> factory)
    {
