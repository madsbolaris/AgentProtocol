...
";
        ...
        var content = Assert.IsType<TextContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Text);
        Assert.Equal(testValue, content.Text);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<FunctionCallContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.CallId);
        Assert.Equal(testValue, content.CallId);
    }
...
";
        ...
        Assert.Equal(testValue, content.Name);
    }
...
";
        ...
        Assert.Equal(testValue, content.Arguments);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<FunctionResultContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.CallId);
        Assert.Equal(testValue, content.CallId);
    }
...
";
        ...
        Assert.Equal(testValue, content.Result);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<ErrorContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Code);
        Assert.Equal(testValue, content.Code);
    }
...
";
        ...
        Assert.Equal(testValue, content.Message);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<ErrorContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.StackTrace);
        Assert.Equal(testValue, content.StackTrace);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<TextReasoningContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Text);
        Assert.Equal(testValue, content.Text);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<TextReasoningContent>(message.Contents.FirstOrDefault());
        Assert.True(bool.TryParse(testValue, out var expectedValue));
        Assert.Equal(expectedValue, content.Exposed);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<DataContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Uri);
        Assert.Equal(testValue, content.Uri);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<DataContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.MimeType);
        Assert.Equal(testValue, content.MimeType);
    }
...
";
        ...
        Assert.Equal(testValue, content.Value);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<UriContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Uri);
        Assert.Equal(testValue, content.Uri);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<ImageContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Uri);
        Assert.Equal(testValue, content.Uri);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<ImageContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Alt);
        Assert.Equal(testValue, content.Alt);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<ImageContent>(message.Contents.FirstOrDefault());
        Assert.True(int.TryParse(testValue, out var expectedValue));
        Assert.Equal(expectedValue, content.Width);
    }
...
";
        ...
        var content = Assert.IsType<ImageContent>(message.Contents.FirstOrDefault());
        Assert.True(int.TryParse(testValue, out var expectedValue));
        Assert.Equal(expectedValue, content.Height);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<AudioContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Uri);
        Assert.Equal(testValue, content.Uri);
    }
...
";
        ...
        var content = Assert.IsType<AudioContent>(message.Contents.FirstOrDefault());
        Assert.True(int.TryParse(testValue, out var expectedValue));
        Assert.Equal(expectedValue, content.Duration);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<TranscriptContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Text);
        Assert.Equal(testValue, content.Text);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<TranscriptContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Language);
        Assert.Equal(testValue, content.Language);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<TranscriptContent>(message.Contents.FirstOrDefault());
        Assert.True(double.TryParse(testValue, out var expectedValue));
        Assert.Equal(expectedValue, content.Confidence, 2);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<TranscriptContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Speaker);
        Assert.Equal(testValue, content.Speaker);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<VideoContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Uri);
        Assert.Equal(testValue, content.Uri);
    }
...
";
        ...
        var content = Assert.IsType<VideoContent>(message.Contents.FirstOrDefault());
        Assert.True(int.TryParse(testValue, out var expectedValue));
        Assert.Equal(expectedValue, content.FrameRate);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<FileContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Uri);
        Assert.Equal(testValue, content.Uri);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<FileContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Filename);
        Assert.Equal(testValue, content.Filename);
    }
...
";
        ...
        var content = Assert.IsType<FileContent>(message.Contents.FirstOrDefault());
        Assert.True(int.TryParse(testValue, out var expectedValue));
        Assert.Equal(expectedValue, content.SizeBytes);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<SearchResultContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Title);
        Assert.Equal(testValue, content.Title);
    }
...
";
        ...
        Assert.Equal(testValue, content.Url);
    }
...
";
        ...
        var content = Assert.IsType<SearchResultContent>(message.Contents.FirstOrDefault());
        Assert.True(double.TryParse(testValue, out var expectedValue));
        Assert.Equal(expectedValue, content.Score, 2);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<SearchResultContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Snippet);
        Assert.Equal(testValue, content.Snippet);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<DocumentContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Title);
        Assert.Equal(testValue, content.Title);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<DocumentContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.DocumentId);
        Assert.Equal(testValue, content.DocumentId);
    }
...
";
        ...
        Assert.Equal(testValue, content.Source);
    }
...
";
        ...
        Assert.Equal(testValue, content.Content);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<AdaptiveCardContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Version);
        Assert.Equal(testValue, content.Version);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<AdaptiveCardContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.FallbackText);
        Assert.Equal(testValue, content.FallbackText);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<AdaptiveCardContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Card);
        Assert.Equal(testValue, content.Card);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<RefusalContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Reason);
        Assert.Equal(testValue, content.Reason);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<ContentFilterResultContent>(message.Contents.FirstOrDefault());
        Assert.True(bool.TryParse(testValue, out var expectedValue));
        Assert.Equal(expectedValue, content.Filtered);
    }
...
";
        ...
        Assert.Equal(testValue, content.Category);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<ContentFilterResultContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Severity);
        Assert.Equal(testValue, content.Severity);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<UserInputRequestContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.RequestId);
        Assert.Equal(testValue, content.RequestId);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<UserInputRequestContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Prompt);
        Assert.Equal(testValue, content.Prompt);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<UserInputRequestContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.InputType);
        Assert.Equal(testValue, content.InputType);
    }
...
";
        ...
        var content = Assert.IsType<UserInputRequestContent>(message.Contents.FirstOrDefault());
        Assert.True(bool.TryParse(testValue, out var expectedValue));
        Assert.Equal(expectedValue, content.Required);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<EventContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Name);
        Assert.Equal(testValue, content.Name);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<TraceContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Name);
        Assert.Equal(testValue, content.Name);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<TraceContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Label);
        Assert.Equal(testValue, content.Label);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<ActionContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.Name);
        Assert.Equal(testValue, content.Name);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<TypingIndicatorContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.From);
        Assert.Equal(testValue, content.From);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<MessageReactionContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.ReferencedMessageId);
        Assert.Equal(testValue, content.ReferencedMessageId);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<MessageDeleteContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.MessageId);
        Assert.Equal(testValue, content.MessageId);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<MessageUpdateContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.MessageId);
        Assert.Equal(testValue, content.MessageId);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<HostedFileContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.FileId);
        Assert.Equal(testValue, content.FileId);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<HostedFileContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.MediaType);
        Assert.Equal(testValue, content.MediaType);
    }
...
";
        ...
        // Assert: Verify property value
        Assert.NotNull(message);
        var content = Assert.IsType<HostedVectorStoreContent>(message.Contents.FirstOrDefault());
        Assert.NotNull(content.VectorStoreId);
        Assert.Equal(testValue, content.VectorStoreId);
    }
...
";
        ...
        var content = Assert.IsType<HostedVectorStoreContent>(message.Contents.FirstOrDefault());
        Assert.True(int.TryParse(testValue, out var expectedValue));
        Assert.Equal(expectedValue, content.DocumentCount);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<TextContent>(message.Contents.FirstOrDefault());
        Assert.Equal("text", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<FunctionResultContent>(message.Contents.FirstOrDefault());
        Assert.Equal("functionResult", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<ErrorContent>(message.Contents.FirstOrDefault());
        Assert.Equal("error", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<TextReasoningContent>(message.Contents.FirstOrDefault());
        Assert.Equal("reasoning", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<DataContent>(message.Contents.FirstOrDefault());
        Assert.Equal("data", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<ImageContent>(message.Contents.FirstOrDefault());
        Assert.Equal("image", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<AudioContent>(message.Contents.FirstOrDefault());
        Assert.Equal("audio", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<TranscriptContent>(message.Contents.FirstOrDefault());
        Assert.Equal("transcript", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<VideoContent>(message.Contents.FirstOrDefault());
        Assert.Equal("video", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<FileContent>(message.Contents.FirstOrDefault());
        Assert.Equal("file", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<SearchResultContent>(message.Contents.FirstOrDefault());
        Assert.Equal("searchResult", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<DocumentContent>(message.Contents.FirstOrDefault());
        Assert.Equal("document", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<AdaptiveCardContent>(message.Contents.FirstOrDefault());
        Assert.Equal("adaptiveCard", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<RefusalContent>(message.Contents.FirstOrDefault());
        Assert.Equal("refusal", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<ContentFilterResultContent>(message.Contents.FirstOrDefault());
        Assert.Equal("contentFilterResult", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<UserInputRequestContent>(message.Contents.FirstOrDefault());
        Assert.Equal("userInputRequest", content.Kind);
    }
...
";
        ...
        // Assert: Verify correct type is instantiated
        Assert.NotNull(message);
        var content = Assert.IsType<SuggestedActionsContent>(message.Contents.FirstOrDefault());
        Assert.Equal("suggestedActions", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<EventContent>(message.Contents.FirstOrDefault());
        Assert.Equal("event", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<TraceContent>(message.Contents.FirstOrDefault());
        Assert.Equal("trace", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<ActionContent>(message.Contents.FirstOrDefault());
        Assert.Equal("action", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<TypingIndicatorContent>(message.Contents.FirstOrDefault());
        Assert.Equal("typingIndicator", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<MessageReactionContent>(message.Contents.FirstOrDefault());
        Assert.Equal("messageReaction", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<MessageDeleteContent>(message.Contents.FirstOrDefault());
        Assert.Equal("messageDelete", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<MessageUpdateContent>(message.Contents.FirstOrDefault());
        Assert.Equal("messageUpdate", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<HostedFileContent>(message.Contents.FirstOrDefault());
        Assert.Equal("hostedFile", content.Kind);
    }
...
";
        ...
        Assert.NotNull(message);
        var content = Assert.IsType<HostedVectorStoreContent>(message.Contents.FirstOrDefault());
        Assert.Equal("hostedVectorStore", content.Kind);
    }
