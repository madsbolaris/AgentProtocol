...
class TestAnonymousModeEndpoints:
    ...
    async def test_root_endpoint_returns_ok(self, test_client):
        ...
        assert "Python Echo Bot" in data["name"]
...
class TestEchoBotFunctionality:
    """Test that echo bot actually echoes messages correctly."""

    @pytest.mark.asyncio
    async def test_echo_bot_echoes_simple_message(self, test_client):
    ...
    @pytest.mark.asyncio
    async def test_echo_bot_responds_to_hello(self, test_client):
