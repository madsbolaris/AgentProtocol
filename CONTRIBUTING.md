...
> **Note:** This file provides a quick overview. For complete contribution guidelines, see [docs/contributing.md](docs/contributing.md).
...
```markdown
<!-- Before -->
[Run Lifecycle](docs/specifications/run-lifecycle.md)
